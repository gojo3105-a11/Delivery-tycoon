...
export const RARITY = [
  ...
  { name: '영웅', color: '#2EA856', bg: 'rgba(46,168,86,.12)',   mul: 2.5 },
  { name: '전설', color: '#D4A017', bg: 'rgba(212,160,23,.12)',  mul: 4.0 },
  { name: '신화', color: '#8B55C9', bg: 'rgba(139,85,201,.12)',  mul: 7.0 },
];

// 고슴도치 배달원 도감 (GDD S6) — 등급별 5종
export const COURIER_NAMES = [
  ['솜털이', '두부', '밤톨이', '고구마', '당근이'],
  ['스쿠터본', '쫑긋이', '두꺼비팩', '참깨', '번개빌리'],
  ['가시대왕', '솔이장군', '드리프터', '허브마스터', '새벽별이'],
  ['가시황제 렉스', '쏘니카', '철갑 루스트', '황금팩 마이다스', '가시라 여왕'],
  ['오르가 신', '드래곤라이더 포켓', '사이버 HH-9000', '코스모', '태초의 프라임'],
];
